...
import kieker.monitoring.probe.spring.executions.CommonUtils;
...
import org.hibernate.hql.internal.ast.exec.*;
...
public class QueryTranslatorImpl implements FilterTranslator {
    private static final CoreMessageLogger LOG = Logger.getMessageLogger(
            ...
            org.hibernate.hql.internal.ast.QueryTranslatorImpl.class.getName()
    );
...
//        CommonUtils.add(new ArrayList<String>().add(sql));
//        CommonUtils.dbUrl = getUrl();
    }
    ...
    public String getUrl() {
        ...
        if(props.containsKey("hibernate.connection.url")){
            ...
            url = ((BasicDataSource)props.get("hibernate.connection.datasource")).getUrl();
        }
        return url;
    }
